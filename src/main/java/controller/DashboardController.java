...
public class DashboardController {
    ...
    void initialize() {
        assert label != null 
                : "fx:id=\"label\" was not injected: check your FXML file 'Dashboard.fxml'.";
        ...
        assert TLCount != null 
                : "fx:id=\"TLCount\" was not injected: check your FXML file 'Dashboard.fxml'.";
        ...
        assert PLCount != null 
                : "fx:id=\"PLCount\" was not injected: check your FXML file 'Dashboard.fxml'.";

        AppUserCount appUserCount = new AppUserCountHandler().handle();

        FXCollections
                .observableArrayList(new PieChart.Data("Admin", appUserCount.getNumberOfAdmins()),
        ...
        FXCollections
                .observableArrayList(new PieChart.Data("Team Leaders", leaderCount.getTeamLeaderCount()),
        ...
        series1.getData().add(new XYChart.Data(CEN, countPerCollege.getStudents().size()));
