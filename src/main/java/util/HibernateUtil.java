    ...
    static {
        try {
            Configuration conf = new Configuration().addAnnotatedClass(entity.Activity.class)
                    ...
                    .addAnnotatedClass(entity.ActivityAttendancePK.class).addAnnotatedClass(entity.Group.class)
                    .addAnnotatedClass(entity.Student.class).addAnnotatedClass(entity.StudentLeader.class)
